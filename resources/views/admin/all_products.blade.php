...
@foreach($posts as $post)
    ...
    <div class="card-blog">
        ...
        <div style="display:flex;flex-direction:row;flex-wrap:wrap;padding:15px;">
        ...
        <div style="display:flex;flex-direction:row;justify-content:space-between;padding:20px;">
            ...
            <a href="product/{{$post->id}}/edit" class="btn btn-primary">Edit</a>
            <a href="product/{{$post->id}}/delete" class="btn btn-danger">Delete</a>
